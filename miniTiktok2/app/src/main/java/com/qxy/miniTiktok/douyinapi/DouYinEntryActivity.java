package com.qxy.miniTiktok.douyinapi;
...
//import com.qxy.miniTiktok.DemoMainAct;

import com.qxy.miniTiktok.act.NewMainAct;
...
//    AppDatabase db = DataBaseManager.INSTANCE.getDb();
    ...
    public void onResp(BaseResp resp) {
        if (resp.getType() == CommonConstants.ModeType.SHARE_CONTENT_TO_TT_RESP) {
            ...
            if (resp.isSuccess()) {
                ...
                Log.d("code", "onResp: "+response.authCode);

//                user = new User(0, response.authCode,"","","");
